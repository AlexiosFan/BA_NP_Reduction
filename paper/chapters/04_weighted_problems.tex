...
\problem{Partition}{A list $as$ of natural numbers.}{Is there a sub-list $as' \subset as$ s.t. 
\begin{align*} 
...
\problem{Subset Sum in List}{
    ...
    \begin{align*}
        \sum_{x \in as'} x = s \tag{3} \label{eq:3}
    \end{align*}
}
\begin{myalign}
...
\subsection{Knapsack}
\problem{Knapsack}{A finite set S, a weighting function $w$, a limiting function $b$, an upperbound $W$, a lowerbound $B$}{
